...
public class TestGame extends Game implements ButtonListener {
	...
	public void init() {
		...
		texture2 = Resources.loadArrayTexture("megaman_sheet.png", 1, 4);
		Animation animWalk = new Animation(new int[]{1,2,3}, new float[]{0.2f,0.2f,0.2f});
		...
		Button button = new Button(new Rectangle(0.0f, -0.45f, 0.5f, 0.15f), "Test");
		button.registerButtonListener(this);
		button.setBackgroundColor(Color.RED);
		ui.addUserInterfaceComponent(button);
		
		mapTexture = Resources.loadArrayTexture("lava_level.png", 5, 4);
	...
	public void render() {
		...
		ui.tick(0.16f);
		getRenderSystem().renderText("Test", font, 0, 0);
	}
